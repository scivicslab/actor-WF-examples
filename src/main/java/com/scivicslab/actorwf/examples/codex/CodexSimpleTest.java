...
/**
 * Simple test application demonstrating basic Codex session interaction.
 * <p>
 * This test sends three simple prompts to Codex and captures the responses,
...
public class CodexSimpleTest {
    ...
    public static void main(String[] args) {
        ActorSystem system = new ActorSystem.Builder("codex-simple-system").build();

        String sessionName = "codex-simple-" + System.currentTimeMillis();
